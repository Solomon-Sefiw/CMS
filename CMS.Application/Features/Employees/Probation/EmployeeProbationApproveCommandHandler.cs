...
{
    public class EmployeeProbationApproveCommand : IRequest<int>
    {
    ...
    public class EmployeeProbationApproveCommandHandler : IRequestHandler<EmployeeProbationApproveCommand, int>
    {
        private readonly IDataService dataService;
        private readonly IEmployeeChangeLogService employeeChangeLogService;
        public EmployeeProbationApproveCommandHandler(IDataService dataService ,IEmployeeChangeLogService employeeChangeLogService)
        {
        ...
        public async Task<int> Handle(EmployeeProbationApproveCommand request, CancellationToken cancellationToken)
        {
