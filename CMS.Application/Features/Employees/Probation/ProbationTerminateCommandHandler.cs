...
{
    public class ProbationTerminateCommand : IRequest<int>
    {
    ...
    public class ProbationTerminateCommandHandler : IRequestHandler<ProbationTerminateCommand, int>
    {
        private readonly IDataService dataService;
        private readonly IEmployeeChangeLogService employeeChangeLogService;
        public ProbationTerminateCommandHandler(IDataService dataService ,IEmployeeChangeLogService employeeChangeLogService)
        {
            this.dataService = dataService;
            this.employeeChangeLogService = employeeChangeLogService;

        }
        public async Task<int> Handle(ProbationTerminateCommand request, CancellationToken cancellationToken)
        {

            var employee = await dataService.Employees.FindAsync(request.EmployeeId);
            employee.EmployeeStatus = EmployeeStatusEnum.Terminated;
