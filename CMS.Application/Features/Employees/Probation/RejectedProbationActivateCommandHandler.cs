...
{
    public class RejectedProbationActivateCommand : IRequest<int>
    {
    ...
    public class RejectedProbationActivateCommandHandler : IRequestHandler<RejectedProbationActivateCommand, int>
    {
        private readonly IDataService dataService;
        private readonly IEmployeeChangeLogService employeeChangeLogService;
        public RejectedProbationActivateCommandHandler(IDataService dataService ,IEmployeeChangeLogService employeeChangeLogService)
        {
            this.dataService = dataService;
            this.employeeChangeLogService = employeeChangeLogService;

        }
        public async Task<int> Handle(RejectedProbationActivateCommand request, CancellationToken cancellationToken)
        {
