...
{
    public class SubmitBenefitValueCommandHandler : IRequestHandler<SubmitBenefitValueCommand, int>
    {
        private readonly IDataService _dataService;
        public SubmitBenefitValueCommandHandler(IDataService dataService)
        {
            _dataService = dataService;
        }
        public async Task<int> Handle(SubmitBenefitValueCommand request, CancellationToken cancellationToken)
        {
            ...
            benefitValue.ApprovalStatus = ApprovalStatus.Submitted;
