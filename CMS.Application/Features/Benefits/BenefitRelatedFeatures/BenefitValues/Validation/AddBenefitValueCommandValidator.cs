...
{
    public class AddBenefitValueCommandValidator : AbstractValidator<AddBenefitValueCommand>
    {
        private readonly IDataService _dataService;
        public AddBenefitValueCommandValidator(IDataService dataService)
        {
        ...
        private async Task<bool> BeUniqueBenefitValue(decimal value, CancellationToken cancellationToken)
        {
