...
export const ReceivedLetters = () => {
  ...
  const receivedLetters = lettersData?.items || [];

  const filteredReceivedLetters = searchQuery
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredReceivedLetters.length === 0 && !isDataLoading;
    ...
    <Box>
      {isDataLoading ? (
        ...
        <>
          ...
          {filteredReceivedLetters.length > 0 ? (
            <Paper>
              <TableContainer>
                <Table size="medium">
                  <TableHead>
                  ...
                  <TableBody>
                    {filteredReceivedLetters.map((item: LetterDto) => (
