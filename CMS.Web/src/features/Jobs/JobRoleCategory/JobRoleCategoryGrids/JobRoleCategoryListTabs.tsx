...
import {
  JobRolesCountsByStatus,
  RegionCountsByStatus,
} from "../../../../app/store";
...
const getTabs = ({
  ...
  {
    label: "JobRoleCategories",
    href: "/job-role-category",
    counts: undefined,
    color: "success",
  },
  {
    label: "Approval Requests",
    href: "/job-role-category/approval-requests",
    counts: submitted,
    color: "primary",
  },
  {
    label: "Rejected",
    href: "/job-role-category/rejected-approval-requests",
    counts: rejected,
    color: "error",
  },
  {
    label: "Draft",
    href: "/job-role-category/draft",
    counts: draft,
    color: "info",
  },
];

export const JobRoleCategoryListTabs = ({
  counts,
}: {
