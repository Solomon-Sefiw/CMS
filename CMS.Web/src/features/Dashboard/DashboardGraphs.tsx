...
//   const {
//     data: employeeChiefCatagoryGroupData,
//     isLoading: isEmployeeChiefCatagoryGroupLoading,
//     error: employeeChiefCatagoryGroupError,
//   } = useGetEmployeeChiefGroupCountQuery();

//   const businessUnitData: { name: string; employees: number }[] = Array.isArray(employeeChiefCatagoryGroupData)
//     ? employeeChiefCatagoryGroupData.map((item: ChiefGroupData) => ({
//         name: item.chiefOfficeName,
...
//         {permissions.CanViewEmployeeDistributionByChiefOfficeBarChart && (
//           <Grid item xs={12} md={6}>
//             <Card elevation={3}>
//               <CardContent>
//                 <Box
...
//                     title={
//                       <span style={{ color: "#3F51B9", textAlign: "center", display: "block" }}>
//                         Shows number of employees grouped by their chief office
//                       </span>
//                     }
//                     arrow
//                     placement="top"
...
//                       sx={{ color: "#3F51B9", fontFamily: "Neo Sans Pro, sans-serif", cursor: "help" }}
//                     >
//                       Employee Distribution By Chief Office
//                     </Typography>
//                   </MuiTooltip>

//                   <IconButton  sx={{ color: "#3F51B9" }} disabled = {!permissions.canViewSetup} size="small" onClick={() => handleNavigation("/businessunit")}>
//                     <Business  />
//                   </IconButton>
//                 </Box>

//                 {isEmployeeChiefCatagoryGroupLoading ? (
//                   <Typography variant="body2" color="text.secondary">
//                     Loading chart...
//                   </Typography>
//                 ) : employeeChiefCatagoryGroupError ? (
