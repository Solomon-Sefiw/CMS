...
export const ApprovedPromotion = () => {
          ...
          <Paper elevation={3} sx={{ borderRadius: 2, overflow: 'hidden' }}>
                          ...
                          <TableRow hover>
                            ...
                            <TableCell>
                              <Stack direction="row" spacing={1}>
                                ...
                                {promotion.transactionStatus === EmployeeTransactionStatus.Draft && (
                                  <>
                                    <Button 
                                      variant="outlined" 
                                      size="small"
            ...
            {!EmployeePromotionList?.items?.length && (
              <Box sx={{ p: 3, textAlign: 'center' }}>
                <Typography color="textSecondary">No promotion records found</Typography>
              </Box>
            )}
          </Paper>
        </AccordionDetails>
