...
export const RejectedEducationLevels = () => {
  ...
  const rejectedEducationLevels = educationLevelsData?.items || [];

  // Filter education levels based on searchQuery
  const filteredRejectedEducationLevels = searchQuery
    ? rejectedEducationLevels.filter(
        (educationLevel) =>
          educationLevel.name
            ?.toLowerCase()
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredRejectedEducationLevels.length === 0;
  ...
  console.log(filteredRejectedEducationLevels);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredRejectedEducationLevels.map(
