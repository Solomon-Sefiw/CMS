...
export const DraftEducationLevels = () => {
  ...
  const draftEducationLevels = educationLevelsData?.items || [];

  // Filter education levels based on searchQuery
  const filteredDraftEducationLevels = searchQuery
    ? draftEducationLevels.filter(
        (educationLevel) =>
          educationLevel.name
            ?.toLowerCase()
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredDraftEducationLevels.length === 0;
  ...
  console.log(filteredDraftEducationLevels);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredDraftEducationLevels.map((item: EducationLevelDto) => (
