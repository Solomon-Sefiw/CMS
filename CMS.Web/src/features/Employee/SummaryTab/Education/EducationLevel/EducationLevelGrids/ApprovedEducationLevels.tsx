...
export const ApprovedEducationLevels = () => {
  ...
  const approvedEducationLevels = educationLevelsData?.items || [];

  // Filter education levels based on searchQuery
  const filteredApprovedEducationLevels = searchQuery
    ? approvedEducationLevels.filter(
        (educationLevel) =>
          educationLevel.name
            ?.toLowerCase()
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredApprovedEducationLevels.length === 0;
  ...
  console.log(filteredApprovedEducationLevels);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredApprovedEducationLevels.map(
