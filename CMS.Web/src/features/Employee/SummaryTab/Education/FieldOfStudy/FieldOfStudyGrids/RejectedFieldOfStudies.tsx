...
export const RejectedFieldOfStudies = () => {
  ...
  const rejectedFieldOfStudies = fieldOfStudiesData?.items || [];

  const filteredRejectedFieldOfStudies = searchQuery
    ? rejectedFieldOfStudies.filter(
        (fieldOfStudy) =>
          fieldOfStudy.name
            ?.toLowerCase()
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredRejectedFieldOfStudies.length === 0;
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredRejectedFieldOfStudies.map(
