...
export const ApprovedInstitutionNames = () => {
  ...
  const approvedInstitutionNames = institutionNamesData?.items || [];

  const filteredApprovedInstitutionNames = searchQuery
    ? approvedInstitutionNames.filter(
        (institutionName) =>
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredApprovedInstitutionNames.length === 0;
  ...
  console.log(filteredApprovedInstitutionNames);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredApprovedInstitutionNames.map((item: any) => (
