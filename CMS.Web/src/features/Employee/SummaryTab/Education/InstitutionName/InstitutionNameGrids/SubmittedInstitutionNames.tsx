...
export const SubmittedInstitutionNames = () => {
  ...
  const submittedInstitutionNames = institutionNamesData?.items || [];

  const filteredSubmittedInstitutionNames = searchQuery
    ? submittedInstitutionNames.filter(
        (institutionName) =>
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredSubmittedInstitutionNames.length === 0;
  ...
  console.log(filteredSubmittedInstitutionNames);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredSubmittedInstitutionNames.map((item: any) => (
