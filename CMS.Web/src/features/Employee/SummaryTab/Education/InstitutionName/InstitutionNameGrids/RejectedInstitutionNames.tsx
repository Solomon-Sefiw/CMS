...
export const RejectedInstitutionNames = () => {
  ...
  const rejectedInstitutionNames = institutionNamesData?.items || [];

  const filteredRejectedInstitutionNames = searchQuery
    ? rejectedInstitutionNames.filter(
        (institutionName) =>
  ...
  const showNoMatchingResultsAlert =
    searchQuery && filteredRejectedInstitutionNames.length === 0;
  ...
  console.log(filteredRejectedInstitutionNames);
  return (
    <Box>
        ...
        <Paper>
          <TableContainer>
            <Table size="medium">
              ...
              <TableBody>
                {filteredRejectedInstitutionNames.map((item: any) => (
