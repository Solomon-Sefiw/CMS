...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      approveCase: build.mutation<ApproveCaseApiResponse, ApproveCaseApiArg>({
        query: (queryArg) => ({
          url: `/api/Case/approve-approval-request`,
          method: "POST",
      ...
      rejectCaseApprovalRequest: build.mutation<
        RejectCaseApprovalRequestApiResponse,
        RejectCaseApprovalRequestApiArg
      >({
        query: (queryArg) => ({
          url: `/api/Case/reject-approval-request`,
          method: "POST",
          body: queryArg.changeWorkflowStatusEntityDto,
        }),
        invalidatesTags: ["Case", "Dashboard"],
      }),
      submitCaseForApproval: build.mutation<
        SubmitCaseForApprovalApiResponse,
        SubmitCaseForApprovalApiArg
      >({
        query: (queryArg) => ({
          url: `/api/Case/submit-for-approval`,
          method: "POST",
          body: queryArg.changeWorkflowStatusEntityDto,
        }),
        invalidatesTags: ["Case", "Dashboard"],
      ...
      downloadCaseFileDocument: build.query<
        DownloadCaseFileDocumentApiResponse,
        DownloadCaseFileDocumentApiArg
      >({
        query: (queryArg) => ({
          url: `/api/CaseFileDocuments/DownloadCaseFileDocument/${queryArg.id}`,
        }),
        providesTags: ["CaseFileDocuments"],
      }),
      getCaseFileById: build.query<
        GetCaseFileByIdApiResponse,
        GetCaseFileByIdApiArg
      >({
        query: (queryArg) => ({
          url: `/api/CaseFileDocuments/get/${queryArg.id}`,
        }),
        providesTags: ["CaseFileDocuments"],
      }),
      getCaseFileDocumentByCaseId: build.query<
        GetCaseFileDocumentByCaseIdApiResponse,
        GetCaseFileDocumentByCaseIdApiArg
      >({
        query: (queryArg) => ({
          url: `/api/CaseFileDocuments/getDocumentByCaseId/${queryArg.caseId}`,
        }),
        providesTags: ["CaseFileDocuments"],
      }),
      updateCaseFileDocument: build.mutation<
        UpdateCaseFileDocumentApiResponse,
        UpdateCaseFileDocumentApiArg
      >({
        query: (queryArg) => ({
        ...
        invalidatesTags: ["CaseFileDocuments"],
      }),
      uploadCaseFileDocument: build.mutation<
        UploadCaseFileDocumentApiResponse,
        UploadCaseFileDocumentApiArg
      >({
        query: (queryArg) => ({
      ...
      >({
        query: (queryArg) => ({
          url: `/api/CaseTemplate/GetTemplateById`,
          params: { id: queryArg.id },
        }),
        providesTags: ["CaseTemplate"],
      }),
      ...
      >({
        query: (queryArg) => ({
          url: `/api/CaseTimeline/GetTimelineById`,
          params: { id: queryArg.id },
        }),
        providesTags: ["CaseTimeline"],
      }),
      ...
      approveChilot: build.mutation<
        ApproveChilotApiResponse,
        ApproveChilotApiArg
      >({
        query: (queryArg) => ({
          url: `/api/Chilot/approve`,
          method: "PATCH",
          body: queryArg.approveChilotCommand,
        }),
        invalidatesTags: ["Chilot", "Dashboard"],
      }),
      ...
      getChilotCountPerStatus: build.query<
        GetChilotCountPerStatusApiResponse,
        GetChilotCountPerStatusApiArg
      >({
        query: () => ({ url: `/api/Chilot/count` }),
        providesTags: ["Chilot"],
      }),
      ...
      getAllChilot: build.query<GetAllChilotApiResponse, GetAllChilotApiArg>({
        query: () => ({ url: `/api/Chilot/GetAll` }),
        providesTags: ["Chilot"],
      }),
      getChilotsForPagination: build.query<
        GetChilotsForPaginationApiResponse,
        GetChilotsForPaginationApiArg
      >({
        query: (queryArg) => ({
          url: `/api/Chilot/GetChilotsForPagination`,
          params: {
            status: queryArg.status,
            pageNumber: queryArg.pageNumber,
            pageSize: queryArg.pageSize,
      ...
      rejectChilot: build.mutation<RejectChilotApiResponse, RejectChilotApiArg>(
        {
          query: (queryArg) => ({
            url: `/api/Chilot/Reject`,
            method: "PATCH",
            body: queryArg.rejectChilotCommand,
          }),
          invalidatesTags: ["Chilot", "Dashboard"],
        }
      ),
      searchAllChilots: build.query<
        SearchAllChilotsApiResponse,
        SearchAllChilotsApiArg
      >({
        query: () => ({ url: `/api/Chilot/search` }),
        providesTags: ["Chilot"],
      }),
      submitChilot: build.mutation<SubmitChilotApiResponse, SubmitChilotApiArg>(
        {
          query: (queryArg) => ({
            url: `/api/Chilot/submit`,
            method: "PATCH",
            body: queryArg.submitChilotCommand,
          }),
          invalidatesTags: ["Chilot", "Dashboard"],
        }
      ),
      ...
      >({
        query: (queryArg) => ({
          url: `/api/DocketEntry/GetDocketById`,
          params: { id: queryArg.id },
        }),
        providesTags: ["DocketEntry"],
      }),
      ...
      getPaymentById: build.query<
        GetPaymentByIdApiResponse,
        GetPaymentByIdApiArg
      >({
        query: (queryArg) => ({
...
export type ApproveCaseApiResponse = unknown;
export type ApproveCaseApiArg = {
...
export type RejectCaseApprovalRequestApiResponse = unknown;
export type RejectCaseApprovalRequestApiArg = {
  changeWorkflowStatusEntityDto: ChangeWorkflowStatusEntityDto;
};
export type SubmitCaseForApprovalApiResponse = unknown;
export type SubmitCaseForApprovalApiArg = {
  changeWorkflowStatusEntityDto: ChangeWorkflowStatusEntityDto;
};
...
export type DownloadCaseFileDocumentApiResponse =
  /** status 200 Success */ void;
export type DownloadCaseFileDocumentApiArg = {
  id: string;
};
export type GetCaseFileByIdApiResponse =
  /** status 200 Success */ CaseFileDocumentDto;
export type GetCaseFileByIdApiArg = {
  id: string;
};
export type GetCaseFileDocumentByCaseIdApiResponse =
  /** status 200 Success */ CaseFileDocumentDto[];
export type GetCaseFileDocumentByCaseIdApiArg = {
  caseId: number;
};
export type UpdateCaseFileDocumentApiResponse =
  /** status 200 Success */ string;
export type UpdateCaseFileDocumentApiArg = {
  body: {
    id?: string;
    file?: Blob;
...
export type UploadCaseFileDocumentApiResponse = unknown;
export type UploadCaseFileDocumentApiArg = {
  body: {
    caseId?: number;
...
export type ApproveChilotApiResponse = /** status 200 Success */ number;
export type ApproveChilotApiArg = {
  approveChilotCommand: ApproveChilotCommand;
};
...
export type GetChilotCountPerStatusApiResponse =
  /** status 200 Success */ ChilotCountsByStatus;
export type GetChilotCountPerStatusApiArg = void;
export type CreateChilotApiResponse = /** status 201 Created */ number;
export type CreateChilotApiArg = {
  createChilotCommand: CreateChilotCommand;
};
export type GetAllChilotApiResponse = /** status 200 Success */ ChilotLists;
export type GetAllChilotApiArg = void;
export type GetChilotsForPaginationApiResponse =
  /** status 200 Success */ PaginatedChilotList;
export type GetChilotsForPaginationApiArg = {
  status?: ApprovalStatus;
  pageNumber?: number;
  pageSize?: number;
};
export type RejectChilotApiResponse = /** status 200 Success */ number;
export type RejectChilotApiArg = {
  rejectChilotCommand: RejectChilotCommand;
};
export type SearchAllChilotsApiResponse = /** status 200 Success */ ChilotDto[];
export type SearchAllChilotsApiArg = void;
export type SubmitChilotApiResponse = /** status 200 Success */ number;
export type SubmitChilotApiArg = {
  submitChilotCommand: SubmitChilotCommand;
};
export type UpdateChilotApiResponse = /** status 204 No Content */ void;
...
export type GetPaymentByIdApiResponse = /** status 200 Success */ PaymentDto;
export type GetPaymentByIdApiArg = {
  id?: number;
};
...
export type CaseDocumentType = 1 | 2 | 3 | 4 | 5 | 99;
export type CaseFileDocument = {
  createdAt?: string | null;
  modifiedAt?: string | null;
  createdBy?: string | null;
  modifiedBy?: string | null;
...
export type CaseFileDocumentRead = {
  createdAt?: string | null;
  modifiedAt?: string | null;
  createdBy?: string | null;
  modifiedBy?: string | null;
...
export type PaymentGatewayType = 0 | 1 | 2 | 3 | 4;
...
export type Case = {
  ...
  chilotId?: number | null;
  chilot?: Chilot;
  caseFileDocuments?: CaseFileDocument[] | null;
...
export type CaseRead = {
  ...
  chilotId?: number | null;
  chilot?: Chilot;
  caseFileDocuments?: CaseFileDocumentRead[] | null;
...
export type ActingRead = {
  ...
  previousBusinessUnitId?: number | null;
  isActive?: boolean;
  previousBusinessUnit?: BusinessUnitRead;
  approvalStatus?: ApprovalStatus;
};
...
export type CaseFileDocumentDto = {
  id?: string;
  caseId?: number;
  firstName?: string | null;
  middleName?: string | null;
...
export type ApproveChilotCommand = {
  id?: number;
};
...
export type ChilotCountsByStatus = {
  approved?: number;
  submitted?: number;
  rejected?: number;
  draft?: number;
...
export type ChilotLists = {
  approved?: ChilotDto[] | null;
  submitted?: ChilotDto[] | null;
  rejected?: ChilotDto[] | null;
  draft?: ChilotDto[] | null;
};
export type PaginatedChilotList = {
  items?: ChilotDto[] | null;
  totalCount?: number;
};
export type RejectChilotCommand = {
  id?: number;
};
export type SubmitChilotCommand = {
  id?: number;
};
...
export type EmployeeDemotionRead = {
  ...
  demotionType?: DemotionType;
  businessUnitBeforeId?: number;
  businessUnitBefore?: BusinessUnitRead;
  businessUnitAfterId?: number;
  businessUnitAfter?: BusinessUnitRead;
  beforeGradeSalaryStepId?: number;
  afterGradeSalaryStepId?: number;
  remark?: string | null;
  isBusinessUnitChange?: boolean;
...
export const {
  ...
  useRejectCaseApprovalRequestMutation,
  useSubmitCaseForApprovalMutation,
  useUpdateCaseMutation,
  useDownloadCaseFileDocumentQuery,
  useLazyDownloadCaseFileDocumentQuery,
  useGetCaseFileByIdQuery,
  useLazyGetCaseFileByIdQuery,
  useGetCaseFileDocumentByCaseIdQuery,
  useLazyGetCaseFileDocumentByCaseIdQuery,
  ...
  useGetChilotCountPerStatusQuery,
  useLazyGetChilotCountPerStatusQuery,
  useCreateChilotMutation,
  useGetAllChilotQuery,
  useLazyGetAllChilotQuery,
  useGetChilotsForPaginationQuery,
  useLazyGetChilotsForPaginationQuery,
  useRejectChilotMutation,
  useSearchAllChilotsQuery,
  useLazySearchAllChilotsQuery,
  useSubmitChilotMutation,
